...
ua_ralybot = 'Ralybot https://github.com/KamranMackey/Ralybot'

ua_firefox = 'Mozilla/5.0 (Windows NT 6.3; rv:36.0) Gecko/20100101' \
             ' Firefox/36.0'
ua_old_firefox = 'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; ' \
                 'rv:1.8.1.6) Gecko/20070725 Firefox/2.0.0.6'
ua_internetexplorer = 'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1)'
ua_chrome = 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, ' \
            'like Gecko) Chrome/44.0.2383.0 Safari/537.36'
