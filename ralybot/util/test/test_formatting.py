from ralybot.util.formatting import munge, dict_format, pluralize, strip_colors, truncate, truncate_str, \
...
test_munge_count = 3
test_munge_result_a = "??λ ?όν?? ??φ?ρ ƒφ? ?ό?? φvλ? ??λ ?δ?ÿ ?φ?"
test_munge_result_b = "??λ quick brown fox jumps over the lazy dog"
