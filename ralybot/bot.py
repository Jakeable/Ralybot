...
import ralybot
from ralybot.client import Client
from ralybot.config import Config
from ralybot.reloader import PluginReloader
from ralybot.plugin import PluginManager
from ralybot.event import Event, CommandEvent, RegexEvent, EventType
from ralybot.util import database, formatting
from ralybot.clients.irc import IrcClient

try:
    from ralybot.web.main import WebInterface
    web_installed = True
except ImportError:
    web_installed = False
...
class Ralybot:
    ...
    def __init__(self, loop=asyncio.get_event_loop()):
        ...
        # setup db
        db_path = self.config.get('database', 'sqlite:///ralybot.db')
    ...
    def run(self):
        ...
        :return: True if Ralybot should be restarted, False if it shouldn't.
        :rtype: bool
        """
