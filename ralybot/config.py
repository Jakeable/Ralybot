...
class Config(dict):
    ...
    def load_config(self):
        ...
        if not os.path.exists(self.path):
            ...
            logger.critical("No config file found! Shutting down the bot!")
            print("No config file found! Shutting down the bot in five seconds.")
            print("Copy 'config.default.json' to 'config.json' for defaults.")
            print("For help, see http://git.io/vJ8Mj. Thank you for using Ralybot!")
            time.sleep(5)
            sys.exit()
