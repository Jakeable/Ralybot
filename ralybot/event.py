...
class Event:
    ...
    def __init__(self, *, bot=None, hook=None, conn=None, base_event=None, event_type=EventType.other, content=None,
        ...
        :param bot: The Ralybot instance this event was triggered from
        ...
        :type conn: ralybot.client.Client
        :type hook: ralybot.plugin.Hook
        :type base_event: ralybot.event.Event
        :type content: str
        :type target: str
...
class CommandEvent(Event):
    """
    :type hook: ralybot.plugin.CommandHook
    :type text: str
...
class RegexEvent(Event):
    """
    :type hook: ralybot.plugin.RegexHook
